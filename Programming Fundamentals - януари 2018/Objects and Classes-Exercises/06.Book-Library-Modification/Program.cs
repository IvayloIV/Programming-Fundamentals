...
namespace _06.Book_Library_Modification
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var neededData = DateTime.ParseExact(Console.ReadLine(), "dd.MM.yyyy", CultureInfo.InvariantCulture);
            book
                .Books
                .Where(a => a.ReleaseDate > neededData)
                .OrderBy(a => a.ReleaseDate)
                .ThenBy(a => a.Title).ToList()
                .ForEach(a => Console.WriteLine($"{a.Title} -> {a.ReleaseDate:dd.MM.yyyy}"));
        }
    }
}
